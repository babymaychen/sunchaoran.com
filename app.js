...
//app.use(require('./views/error.jade').http500);
...
// socket.io
app.utility.io = require('socket.io')(app.server);
app.utility.io.on('connection', function (socket) {
    console.log('a user connected');
    socket.on('disconnect', function () {
        console.log('user disconnected');
    });
    socket.on('chat message', function (msg) {
        app.utility.io.emit('chat message', msg);
        console.log(msg);
    });
});
